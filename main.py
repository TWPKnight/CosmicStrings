...
class SpaceCube:
    ...
    def yPlane(self):
        for j in range(len(self.box[0,:,0])):
            for k in range(len(self.box[0,0,:])-1):
                for i in range(len(self.box[:,0,0])-1):                                                                  
                    yFace = np.zeros(4)
                    for p in range(4): 
    ...
    def xPlane(self):
        for i in range(len(self.box[:,0,0])):
            for j in range(len(self.box[0,:,0])-1):
                for k in range(len(self.box[0,0,:])-1):                                                                    
                    xFace = np.zeros(4)
                    for p in range(4): 
    ...
    def zPlane(self):
        for k in range(len(self.box[0,0,:])):
            for j in range(len(self.box[0,:,0])-1):
                for i in range(len(self.box[:,0,0])-1):                                                                    
                    zFace = np.zeros(4)
                    for p in range(4): 
...
print("X(0,1,0) = ",lattice.xString[1,0,0])
print("Y(0,0,0) = ",lattice.yString[0,0,0])
print("Y(1,0,0) = ",lattice.yString[0,1,0])
